            ...
            <x-general.card class="bg-white shadow-lg w-full">
                <div class="relative flex items-center p-5">
                    <div class="ml-4 mr-auto">
                        <div class="text-base font-medium">Regulatory Categories</div>
                    </div>
                </div>
                    <div class="p-5 border-t border-gray-200">
                        <x-tab.title name="0" livewire="">
                            <div class="flex font-semibold">
                                <x-heroicon-o-book-open class="w-6 h-6 mr-2"/>Zakat
                            </div>
                        </x-tab.title>
                        <x-tab.title name="1" livewire="">
                            <div class="flex font-semibold">
                                <x-heroicon-o-clipboard class="w-6 h-6 mr-2"/>LHDN etc
                            </div>
                        </x-tab.title>
                    </div>
            </x-general.card>
        </div>
        <!-- END: Regulatory Categories -->
