            ...
            <x-slot name="content">
                <div class="mt-2 leading-4">
                    <div class="grid gap-2 lg:grid-cols-2 sm:grid-cols-1">
                        <x-form.input type="text" label="Name" value="{{ $name }}"/>
                        <x-form.input type="text" label="Ic No" value="{{ $ic }}"/>
                        <x-form.input type="email" label="Email" value="{{ $email }}"/>
                        <x-form.dropdown label="Gender" value="{{ $gender }}" default="yes">
                            <option value="1">Male</option>
                            <option value="2">Female</option>
                        </x-form.dropdown>
                        <x-form.input type="text" label="House No" value=""/>
                        <x-form.input type="text" label="Phone No" value="60{{ $phone1 }}"/>
                    </div>
