<a class="overflow-hidden relative  transform  hover:scale-105 transition duration-300 shadow-lg rounded-lg intro-y bg-{{ $bg }}"
    href="{{ $cardRoute }}" >
    ...
    <div class="p-5">
        ...
        <div class="flex justify-center">
            <div>
                <div class="mt-3 text-2xl font-bold leading-8 text-center text-white">{{ $value }}</div>
                <div class="mt-1 text-base text-center text-gray-100">{{ $title }}</div>
            </div>
        </div>
    </div>
</a>