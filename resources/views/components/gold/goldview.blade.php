<div>
    ...
    <div class="relative w-64 h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('img/gold/gold1g.png') }}')">
        <div class="bar-value" style="border-radius: 1.5rem; height:{{ 100 - $percentage }}%;" ></div>
    </div>
    ...
    @elseif ($type == '2.5g')
    <div class="relative w-64 h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('img/gold/gold2.5g.png') }}')">
        <div class="bar-value" style="border-radius: 1.5rem; height:{{ 100 - $percentage }}%;" ></div>
    </div>
    <div class="flex items-center justify-center mt-2">
        <div class='text-center'>
    ...
    @elseif ($type == '5g')
    <div class="relative w-64 h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('img/gold/gold5g.png') }}')">
        <div class="bar-value" style="border-radius: 1.5rem; height:{{ 100 - $percentage }}%;" ></div>
    </div>
    <div class="flex items-center justify-center mt-2">
        <div class='text-center'>
    ...
    @elseif ($type == '10g')
    <div class="relative w-64 h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('img/gold/gold10g.png') }}')">
        <div class="bar-value" style="border-radius: 1.5rem; height:{{ 100 - $percentage }}%;" ></div>
    </div>
    <div class="flex items-center justify-center mt-2">
        <div class='text-center'>
    ...
    @elseif ($type == '1kg')
    <div class="relative w-64 h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('img/gold/gold1kg.png') }}')">
        <div class="bar-value" style="border-radius: 1.5rem; height:{{ 100 - $percentage }}%;" ></div>
    </div>
    <div class="flex items-center justify-center mt-2">
        <div class='text-center'>
