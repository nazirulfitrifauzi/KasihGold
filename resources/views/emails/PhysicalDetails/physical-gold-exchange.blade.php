                        ...
                        <td class="body" width="100%" cellpadding="0" cellspacing="0">
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="header1">
                                        <a href="#" style="display: inline-block;">
                                            <img src="{{ asset('img/notify.png') }}" style="width:150px; heigth:150px; "/>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="" style="padding-top: 4px !important;">
                                    <p style="font-weight: bold; font-size:20px;">A new user has requested a physical gold exchange</p>
                                    </td>
                                </tr>
                                <tr>
                                <td>
