<header class="relative z-50 w-full h-24">
    <div class="container flex items-center h-full max-w-6xl px-8 mx-auto justify-between xl:px-0">

        <a href="{{route('leadingpage')}}" class="relative flex items-center inline-block h-5 h-full font-black leading-none mt-2 lg:mt-6">
            <x-logo class="w-auto h-10 lg:h-16 text-indigo-600 fill-current" />
        </a>
