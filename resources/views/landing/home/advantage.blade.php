        ...
        <div class="flex-col items-center ">
            ...
            <div data-aos="flip-up" class="flex flex-col items-center justify-center max-w-2xl py-8 mx-auto xl:flex-row xl:max-w-full">
                <div class="w-full xl:w-1/2 xl:pr-8">
                    ...
                    <blockquote class="flex flex-col items-center justify-between w-full col-span-1 p-6 mt-16 mb-16 text-center transition-all duration-200 rounded-lg bg-gradient-to-br from-yellow-200 to-yellow-400 md:flex-row md:text-left hover:bg-white hover:shadow ease xl:mb-0">
