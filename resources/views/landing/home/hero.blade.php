<div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
    <div class="container flex flex-col items-center justify-between h-full max-w-6xl px-8 mx-auto -mt-32 lg:flex-row xl:px-0">
        <div class="z-30 flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
            <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Memperkasakan Wakaf Ekonomi </h1>
            <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Adakah anda bersedia untuk menyertai kami membangunkan ekonomi melalui wakaf?</p>
            <div class="">
                <a href="{{ route('register') }}" class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-black bg-yellow-300 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">Daftar Sekarang</a>
            </div>
        </div>
        <div class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
            <div class="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
                ...
                {{-- mobile view --}}
                <div class="w-full h-auto mt-20 mb-20 ml-0 lg:mb-0 lg:h-full lg:-ml-12 lg:mt-24 xl:mt-56 xl:-ml-56">
