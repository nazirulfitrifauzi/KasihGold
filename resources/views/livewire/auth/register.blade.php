                    ...
                    <form wire:submit.prevent="registerAgent" x-cloak>
                        ...
                        <div class="mt-6">
                            <div class="flex items-center">
                                ...
                                <label for="tnc" class="block ml-2 text-sm text-gray-900">
                                    I agree to the 
                                    <a class="text-yellow-400 underline " target="_blank" href="{{ asset('pdf/tnc_kap.pdf') }}">
                        ...
                        <div class="mt-6">
                            <span class="block w-full rounded-md shadow-sm">
                                <button type="submit" class="submit_button flex justify-center w-full px-4 py-3 text-sm font-medium text-white bg-yellow-400 border border-transparent rounded-full hover:bg-yellow-300 focus:outline-none">
                                    Register
                                </button>
                            </span>
                        </div>
