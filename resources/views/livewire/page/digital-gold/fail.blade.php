<div>
    ...
    <div class="p-4 mt-4 bg-white">
        <x-table.table>
            ...
            <x-slot name="tbody">
                @forelse ($historyF as $item)
                    ...
                    <tr>
                        ...
                        <x-table.table-body colspan="" class="text-xs font-medium text-gray-700 ">
                            <span class="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-red-100 text-red-800">Cancelled</span>
                        </x-table.table-body>
                    </tr>
                @empty 
                    <tr>
            ...
            <div class="px-2 py-2">
                {{ $historyF->links('pagination-links') }}
            </div>
        </x-table.table>
    </div>
</div>
