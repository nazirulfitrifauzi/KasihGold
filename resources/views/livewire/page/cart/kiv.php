                  ...
                  <tr>
                    ...
                    <x-table.table-body colspan="" class="text-xs font-medium text-gray-700 ">
                      <div class="relative flex flex-row w-24 h-10 mt-1 bg-transparent rounded-lg">
                        ...
                        @if($this->$category==1)
                        <button btnRoute="#" data-id="{{ $cartInfo->id }}" onclick="deleteConfirmation({{ $cartInfo->id }})" class="w-20 h-full text-gray-600 bg-gray-300 rounded-l cursor-pointer hover:text-gray-700 hover:bg-gray-400 focus:outline-none">
                          <span class="m-auto text-2xl font-thin">-</span>
                        </button>
                        @else
                        <button wire:click="subProd({{$cartInfo->products->prod_weight}})" class="w-20 h-full text-gray-600 bg-gray-300 rounded-l cursor-pointer hover:text-gray-700 hover:bg-gray-400 focus:outline-none">
                          <span class="m-auto text-2xl font-thin">-</span>
                        </button>
                        @endif
                        ...
                        <input type="text" class="focus:outline-none text-center w-full bg-gray-300 font-semibold text-md 
                                                      ...
                                                      justify-center
                                                      text-gray-700 
                                                      outline-none" name="custom-input-number" wire:model="qty_{{$cartInfo->products->prod_cat}}" value="qty_{{$cartInfo->products->prod_cat}}"></input>
                        <button wire:click="addProd({{$cartInfo->products->prod_weight}})" class="w-20 h-full text-gray-600 bg-gray-300 rounded-r cursor-pointer hover:text-gray-700 hover:bg-gray-400 focus:outline-none">
                          <span class="m-auto text-2xl font-thin">+</span>
                        </button>
                      </div>
                    </x-table.table-body>
                    ...
                    <x-table.table-body colspan="" class="relative text-xs font-medium text-gray-700">
                      <div class="flex justify-center">
                        <x-btn.tooltip-btn class="flex items-center justify-center text-xs bg-red-600 rounded-full hover:bg-red-700" btnRoute="#" tooltipTitle="Delete" data-id="{{ $cartInfo->id }}" onclick="deleteConfirmation({{ $cartInfo->id }})">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <div>
                      ...
                      <div class="relative flex flex-row w-24 h-10 mt-1 bg-transparent rounded-lg">
                        ...
                        <input type="text" class="focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center justify-center text-gray-700 outline-none" name="custom-input-number" wire:model="qty_{{$cartInfo->products->prod_cat}}" value="qty_{{$cartInfo->products->prod_cat}}"></input>
              ...
              <div class="flex justify-end my-6">
                <div class="w-full px-4 py-4 bg-white border-2 rounded-lg lg:w-1/2">
                  ...
                  <div class="flex justify-center my-6">
                    ...
                    <a type="button" class="flex items-center justify-center w-full px-2 py-2 text-sm font-bold text-white bg-gray-500 rounded focus:outline-none cursor-not-allowed hover:bg-gray-600">
                      <p>Proceed to checkout</p>
                    </a>
                    @else
                    <a href="{{ route('product-buy') }}" class="flex items-center justify-center w-full px-2 py-2 text-sm font-bold text-white bg-yellow-400 rounded focus:outline-none hover:bg-yellow-500">
                      <p>Proceed to checkout</p>
                    </a>
                    @endif
                  </div>
