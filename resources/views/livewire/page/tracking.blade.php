        ...
        <div class="flex col-span-12 lg:col-span-6 xxl:col-span-6 lg:block">
            <x-general.card class="bg-white shadow-lg">
                ...
                <div class="relative w-1/2 m-8">
                    <div class="absolute h-full border-r-4 border-yellow-400 " style="left: 15px"></div>
                    <ul class="p-0 m-0 list-none">
                        <li class="mb-2">
                            <div class="flex items-center mb-1">
                                <div
                                    class="z-20 w-8 h-8 text-white bg-yellow-400 border-4 border-yellow-400 rounded-full">
                    ...
                    <ul class="p-0 m-0 list-none">
                        <li class="mb-2">
                            <div class="flex items-center mb-1">
                                <div
                                    class="z-20 w-8 h-8 text-yellow-400 bg-white border-4 border-yellow-400 rounded-full">
