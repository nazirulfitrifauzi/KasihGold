                ...
                <div class="relative flex flex-col items-center p-5 md:flex-row">
                    ...
                    <div class="ml-0 text-center lg:ml-4 lg:text-left">
                        ...
                        <div>
                            @if ($referral_code != "")
                                <button type="button"
                                        class="flex flex-col items-center px-4 py-2 mt-2 text-sm font-bold text-white bg-blue-500 rounded md:flex-row focus:outline-none tooltipbtn"
