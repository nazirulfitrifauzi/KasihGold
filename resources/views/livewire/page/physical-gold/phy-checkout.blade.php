                        ...
                        <div class="p-4 border-2 rounded-md">
                            ...
                            <div class="py-2 border-b-2">
                                ...
                                <div class="flex justify-between mt-1">
                                    <div>
                                        <p class="text-xs text-gray-500">GRAMMAGE</p>
                                        <p class='text-sm font-semibold'>{{number_format($types->prod_weight,2)}} Gram</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500">TOTAL GRAMMAGE</p>
                                        @if($types->prod_cat=="063")
                                            <p class='text-sm font-semibold text-right'>{{number_format($this->goldbar063*0.25,2)}} Gram</p>
                                        @elseif($types->prod_cat=="064")
                                            <p class='text-sm font-semibold text-right'>{{number_format($this->goldbar064,2)}} Gram</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
