            ...
            <div class="flex justify-end my-6">
                <div class="bg-white py-4 px-4  rounded-lg w-2/5 border-2">
                    ...
                    <div class="flex justify-center my-6">
                        <a href="bank-information"  class="w-full flex items-center justify-center px-2 py-2 text-sm font-bold text-white bg-yellow-400 rounded focus:outline-none hover:bg-yellow-500">
