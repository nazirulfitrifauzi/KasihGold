<div>
    ...
    <div class="bg-white shadow-lg mb-20 sm:mb-0">
        ...
        <div class="py-4 px-4 h-full">
            ...
            <x-form.basic-form wire:submit.prevent="save">
                <x-slot name="content">
                    <div class="grid gap-2 grid-cols-1  lg:grid-cols-6 ">
                    ...
                    <div class="grid gap-2 sm:grid-cols-1 lg:grid-cols-3  mt-6">
                        ...
                        <x-form.input label="Price of Product" value="prod_price" wire:model="prod_price"
                            name="prod_price" />
                    </div>
                    ...
                    <div class="grid gap-2 sm:grid-cols-1 lg:grid-cols-2  mt-2">
                        <x-form.text-area label="Description (Optional)" value="prod_desc" wire:model="prod_desc"
                            name="prod_desc" id="" data-feature="all" rows="8"
