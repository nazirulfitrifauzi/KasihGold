<div>
    ...
    <div class="mt-8 bg-white p-4">
        <div class="flex justify-between my-4">
            ...
            <div wire:loading>
                <div class="flex items-center justify-center text-white absolute bg-yellow-400 p-4 rounded" style="left: 50%; top:50%">
                                        ...
                                        <div class="p-4 mt-4 leading-4">
                                            ...
                                            <div class="mt-5">
                                                <div class="flex mt-1 mb-2 rounded-md shadow-sm">
                                                    <input disabled type="text" value="{{$item->title}}" class="form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 text-gray-400">
                                                </div>
                                            </div>
                                            <div class="mt-5">
                                                <textarea  readonly data-feature="all" rows="8" class=" text-gray-400 appearance-none block w-full h-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5">{{$item->comment}}</textarea>
                                            </div>
                                        </div>
                                    </x-slot>
                                </x-form.basic-form>
