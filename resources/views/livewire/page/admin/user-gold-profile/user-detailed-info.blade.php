<div class="grid grid-cols-12 gap-6 p-4 mt-4 bg-gray-100 rounded-md">
                    ...
                    <x-slot name="content">
                        <x-general.grid mobile="1" gap="0" sm="2" md="2" lg="2" xl="2" class="items-center col-span-12">
                            ...
                            <div class="flex items-center space-x-2">
                                <x-form.input placeholder="" label=""  value="" wire:model="emel"/>
                                <button type="button"
                ...
                <x-form.basic-form wire:submit.prevent="">
                    <x-slot name="content">
                        <x-general.grid mobile="1" gap="2" sm="2" md="2" lg="4" xl="4" class="col-span-12">
                            ...
                            <div class="flex items-center space-x-2">
                                <x-form.input placeholder="" label="Weight (g)"  value="" wire:model='weight' disable="true" />
                                <x-form.input placeholder="" label="Price"  value="" wire:model='price' disable="true" />
                              <button type="submit"
