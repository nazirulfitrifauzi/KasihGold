...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-no-wrap">
        <button class="flex px-4 py-1 text-sm font-bold text-white bg-yellow-400 rounded cursor-pointer hover:bg-yellow-300">Add New User</button>
        ...
        <div class="bg-white shadow-lg rounded-xl">
            <div class="flex flex-col items-center p-5 lg:flex-row">
                ...
                <div class="flex mt-4 lg:mt-0">
                    <button class="flex px-4 py-1 text-sm font-bold text-white bg-yellow-400 rounded cursor-pointer hover:bg-yellow-300" wire:click="" @click="OpenScreening = true" >
                        Screening
                    </button>
                </div>
            </div>
                        ...
                        <tbody>
                            <tr>
                                <td class="px-2 py-2 font-semibold border ">
                                    <a href="#" class="text-blue-600 transition duration-300 ease-in-out cursor-pointer hover:text-blue-400 focus:outline-none">
                                        Office of Foreign Asset Control (OFAC) Sanctions
                                    </a>
                                </td>
                                <td class="px-2 py-4 border ">
                                    <div class="flex items-center justify-center gap-2">
                                        <button class="px-3 py-1 text-xs text-white transition duration-300 ease-in-out bg-teal-600 rounded hover:bg-teal-400 active:bg-teal-700" wire:click="">
                                            Approve
                                        </button>
                                        <button class="px-3 py-1 text-xs text-white transition duration-300 ease-in-out bg-red-600 rounded hover:bg-red-400 active:bg-red-700" wire:click="">
                                            Decline
                                        </button>
                                    </div>
                                </td>
