        ...
        <div class="relative col-span-12 p-4 sm:col-span-12 md:col-span-5 lg:col-span-4">
            <div class="sticky top-4 ">
                ...
                @if($selectedSiri != NULL)
                    <div class="mt-2">
                        <div class="pb-4 border-b">
                            <h1 class="text-lg font-medium">Caj Bidaan RM {{ number_format($cajBida, 2) }}</h1>
                        </div>
                        <div class="p-4 my-6 bg-white rounded-lg shadow-lg">
                            <x-general.grid mobile="1" gap="5" sm="1" md="2" lg="1" xl="1" class="col-span-12 ">
                                ...
                                >
                                <x-form.input
                                    label="Muat Naik Resit Bayaran Caj Bidaan : (hanya boleh muatnaik jpg/png/jpeg/pdf)"
                                    type="file"
                                    value="file"
                                    placeholder=""
                                    wire:model="file"
...
@push('js')
<script>
    window.livewire.on('loadingUpdated', function() {
        loading();
    });
</script>
@endpush
